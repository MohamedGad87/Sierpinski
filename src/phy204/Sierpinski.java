...
public class Sierpinski {
 public static final int SIZE = 700;  // height/width of DrawingPanel
 ...
 public static void main(String[] args) {
     ...
     Point p1 = new Point(0, SIZE);//left node
     Point p2 = new Point(SIZE/2 , 0);// top node
     Point p3 = new Point(SIZE, SIZE);// right node
